...
const GENERATED_FILES = ["national-archive.html", "sitemap.xml", "data/site-search-index.js"];
...
function main() {
  ...
  if (changed.length) {
    console.error("Generated files are out of date. Run npm run generate:archive && npm run generate:sitemap && npm run generate:search, then commit the result.");
