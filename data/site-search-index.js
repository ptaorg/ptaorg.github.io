window.PTA_SITE_SEARCH_INDEX = [
  ...
  [
    "PTA退会・会費を払わない場合・役員の断り方｜保護者向け解説",
    "/guide-parent.html",
    "PTA任意加入・退会、会費を払わない場合、役員を断る場合を区別して解説。入会申込書がないとき、非会員の子ども・記念品・学校行事、学校と教育委員会への確認先を整理します。"
  ],
  [
    "PTA役員の方へ",
    "/guide-pta.html",
  ...
  [
    ...
    "/personnel.html",
    "校長・教頭・教職員のPTA役員、会計、書記、名簿作成、会費徴収、学校連絡システム利用を解説。地方公務員法35条、職専免、校務分掌と学校の事務権限、公的資源の利用を分けます。"
  ],
  [
  ...
  [
    "PTAと学校の個人情報｜名簿提供・本人同意・61条と69条",
    "/privacy.html",
    "学校からPTAへの個人情報・名簿提供と学校自身の目的外利用を解説。個人情報保護法61条・69条、本人同意と恒常運用、口座情報・役員歴、PTAによる直接取得を原典から整理します。"
  ],
  [
