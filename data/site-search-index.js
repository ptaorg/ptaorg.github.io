window.PTA_SITE_SEARCH_INDEX = [
  ...
  [
    "保護者の方へ",
    "/guide-parent.html",
    "PTAの入会、会費、個人情報を学校の手続から分け、学校がPTA非会員を特定しないための確認方法を保護者向けに整理します。"
  ],
  [
    "PTA役員の方へ",
    "/guide-pta.html",
  ...
  [
    "教職員関与と職務専念義務｜学校とPTAの事務を分ける判定基準",
    "/personnel.html",
    "教職員のPTA事務関与を、作業内容、勤務時間、身分、職務上の根拠、職専免・兼職、公的資源の利用から判定し、学校とPTAの事務を分離します。"
  ],
  [
