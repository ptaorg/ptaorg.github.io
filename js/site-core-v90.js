...
(function(){
  ...
  var LOC_GROUPS = {
    ...
    '/privacy-policy.html': 'サイト運営', '/contact.html': 'サイト運営'
  };
  ...
  function initGovernanceFooter() {
    var footer = document.querySelector('footer.footer, footer.site-footer');
    if (!footer || footer.querySelector('.footer-governance')) return;
    var host = footer.querySelector('.footer-inner') || footer;
    var nav = document.createElement('nav');
    nav.className = 'footer-governance';
    nav.setAttribute('aria-label', 'サイト運営情報');
    nav.innerHTML = '<a href="/privacy-policy.html">個人情報取扱方針</a><span aria-hidden="true">・</span><a href="/contact.html">お問い合わせ</a>';
    host.appendChild(nav);
    addStyle('footer-governance-style-v93',
      '.footer-governance{margin:18px 0 0;text-align:center;font-size:.84rem;line-height:1.7}' +
      '.footer-governance a{color:inherit;text-decoration:underline;text-underline-offset:3px}' +
      '.footer-governance span{margin:0 7px;opacity:.6}'
    );
  }
